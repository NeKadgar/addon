...
function Atr_OnLoad()
  ...
  local atrtt1 = CreateFrame( "GameTooltip", "AtrScanningTooltip", nil, BackdropTemplateMixin and "GameTooltipTemplate" ); -- Tooltip name cannot be nil
  if (atrtt1 == nil) then
    zc.msg_anm ("Unable to create AtrScanningTooltip");
  end
  AtrScanningTooltip:SetOwner( WorldFrame, "ANCHOR_NONE" );

  local atrtt2 = CreateFrame( "GameTooltip", "AtrScanningTooltip2", nil, BackdropTemplateMixin and "GameTooltipTemplate" ); -- Tooltip name cannot be nil
  if (atrtt2 == nil) then
...
function Atr_Init()
  ...
  for n = 1, ITEM_HIST_NUM_LINES do
    local y = -5 - ((n-1)*16);
    line = CreateFrame("BUTTON", "AuctionatorHEntry"..n, Atr_Hlist, BackdropTemplateMixin and "Atr_HEntryTemplate");
...
function Atr_AddMainPanel ()
  ...
  local frame = CreateFrame("FRAME", "Atr_Main_Panel", AuctionFrame, BackdropTemplateMixin and "Atr_Sell_Template");
  frame:Hide();
...
function Atr_AddSellTab (tabtext, whichTab)
  ...
  local frame = CreateFrame("Button", framename, AuctionFrame, BackdropTemplateMixin and "AuctionTabTemplate");
...
function Atr_Duration_Initialize(self)
  ...
  if BackdropTemplateMixin == nil and WOW_PROJECT_ID == WOW_PROJECT_CLASSIC then
  ...
  elseif BackdropTemplateMixin and WOW_PROJECT_ID == WOW_PROJECT_CLASSIC then
